...
/**
 * Desactivar Carrier de un mismo tipo
 * @param  {Object}   values {tipo}
 * @param  {Function} fn     next()
 * @return {Function} next()
 */
var desactivarCarriers = function desactivarCarriers(values, fn) {
  ...
  // Crear el mensaje
  db.none(sql.desactivarCarriers, values)
    .then(function() {
      fn(null, {});
    })
...
module.exports = desactivarCarriers;
