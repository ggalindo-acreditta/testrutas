...
module.exports = function() {
  ...
  process.env.HASH_KEY = process.env.HASH_KEY || config.hashkey;
  ...
  process.env.CONFIRM_URL = process.env.CONFIRM_URL || config.confirmUrl;
  process.env.ACCLAIM_URL = process.env.ACCLAIM_URL || config.acclaimUrl;
  process.env.INVITE_URL = process.env.INVITE_URL || config.inviteUrl;
  process.env.LOGO_URL = process.env.LOGO_URL || config.logoUrl;
  // Is in Mock mode?
  ...
  process.env.PATH_SERVIDOR = process.env.PATH_SERVIDOR || config.path.servidor;
  process.env.PATH_ELEMENT_IMAGE = process.env.PATH_ELEMENT_IMAGE || config.path.elementImage;
};
