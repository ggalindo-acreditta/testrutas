-- FUNCTION: public.uf_actualizar_ruta(integer, character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer)
-- DROP FUNCTION public.uf_actualizar_ruta(integer, character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer);
...
END
$BODY$;
ALTER FUNCTION public.uf_actualizar_ruta(integer, character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer)
    OWNER TO postgres;