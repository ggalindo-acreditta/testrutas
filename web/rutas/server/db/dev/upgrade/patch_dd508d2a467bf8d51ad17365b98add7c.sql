...
ALTER TABLE public.element_tree
    ADD COLUMN x integer DEFAULT -1;
ALTER TABLE public.element_tree
    ADD COLUMN y integer DEFAULT -1;
ALTER TABLE public.element_tree
    ADD COLUMN width integer DEFAULT -1;
ALTER TABLE public.element_tree
    ADD COLUMN high integer DEFAULT -1;

-- FUNCTION: public.from uf_registrar_ruta(character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer[], integer[],integer[], integer[],integer);
-- DROP FUNCTION public.uf_registrar_ruta(character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer[], integer[],integer[], integer[],integer);
...
END
$BODY$;
ALTER FUNCTION public.uf_registrar_ruta(character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer[], integer[], integer[], integer[], integer)
 OWNER TO postgres;
 
-- FUNCTION: public.uf_actualizar_ruta(integer, character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer[], integer[], integer[], integer[], integer)
-- DROP FUNCTION public.uf_actualizar_ruta(integer, character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer[], integer[], integer[], integer[], integer);
...
END
$BODY$;
ALTER FUNCTION public.uf_actualizar_ruta(integer, character varying, character varying, character varying, character varying, character varying, materiality, difficulty, character varying, date, integer, character varying, integer[], integer[], integer[], integer[], integer[], integer[], integer)
    OWNER TO postgres;
